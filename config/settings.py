...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Notebook API',
    'DESCRIPTION': 'Comprehensive REST API documentation for the Notebook application covering Academic records, Skills, Study Sessions, Sync, Uploads, and Analytics.',
    'VERSION': '1.0.0',
